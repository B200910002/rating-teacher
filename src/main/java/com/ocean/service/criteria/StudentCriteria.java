...
/**
 * Criteria class for the {@link com.ocean.domain.Student} entity. This class is used
 * in {@link com.ocean.web.rest.StudentResource} to receive all the possible filtering options from
...
public class StudentCriteria implements Serializable, Criteria {
    ...
    /**
     * Class for filtering LoginType
     */
    public static class LoginTypeFilter extends Filter<LoginType> {

        public LoginTypeFilter() {}

        public LoginTypeFilter(LoginTypeFilter filter) {
            super(filter);
        }

        @Override
        public LoginTypeFilter copy() {
            return new LoginTypeFilter(this);
        }
    }
    ...
    private LoginTypeFilter loginType;
    ...
    public StudentCriteria(StudentCriteria other) {
        ...
        this.loginType = other.loginType == null ? null : other.loginType.copy();
    ...
    public LoginTypeFilter getLoginType() {
        return loginType;
    }

    public LoginTypeFilter loginType() {
        if (loginType == null) {
            loginType = new LoginTypeFilter();
        }
        return loginType;
    }

    public void setLoginType(LoginTypeFilter loginType) {
